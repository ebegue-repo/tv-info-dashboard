...
import type { AppState, Auth0PluginOptions, Auth0VueClient, Auth0VueClientOptions } from './interfaces';
import type { GetTokenSilentlyOptions, GetTokenSilentlyVerboseResponse, GetTokenWithPopupOptions, LogoutOptions, LogoutUrlOptions, PopupConfigOptions, PopupLoginOptions, RedirectLoginOptions, RedirectLoginResult } from '@auth0/auth0-spa-js';
/**
 * @ignore
 */
