    ...
    ***************************************************************************** */
    ...
    var Auth0Plugin = /** @class */ (function () {
        ...
        Auth0Plugin.prototype.install = function (app) {
            this._client = new Na(__assign(__assign({}, this.clientOptions), { auth0Client: {
                    name: 'auth0-vue',
                    version: version
                } }));
